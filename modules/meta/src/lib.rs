//! Meta Committee
//! used to vote on among the inner circle:
//! - budget; how fast the budget can change as well (could do this for every metric and impl some Trait for it generally)
//! - maximum wealth gap (measured by gini coefficient) `=>` with a metric and a resolution method (guillame's guillotine)
//!
